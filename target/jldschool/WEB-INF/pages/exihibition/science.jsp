...
<head>
    ...
    <title>My JSP 'kexueyanjiu.jsp' starting page</title>
...
<div class="p1">
    <li><img src="${pageContext.request.contextPath}img/kexueyanjiu.jpg" /></li>
</div>
...
<div>
    ...
    <div id="boxs">
        <ul class="asd">
            <li><a href="#"><img src="${pageContext.request.contextPath}img/keyanxiangmu.jpg" /></a>
                <p><a href="#">科研项目</a>
                <p><a href="#">科研项目概况></a></p>
                </p>
            </li>
            <li><a href="#"><img src="${pageContext.request.contextPath}img/keyanjigou.jpg" /></a>
                <p><a href="#">科研机构</a>
                <p>家里蹲大学几年历史</p>
                </p>
            </li>
            <li><a href="#"><img src="${pageContext.request.contextPath}img/keyanhezuo.jpg" /></a>
                <p><a href="#">科研合作</a>
                <p>家里蹲大学的历任领导简要介绍</p>
                </p>
            </li>
            <li><a href="#"><img src="${pageContext.request.contextPath}img/keyanchengguo.jpg" /></a>
                <p><a href="#">科研成果与知识产权</a>
                <p>家里蹲大学的现任领导简要介绍</p>
                </p>
            </li>
            <li><a href="#"><img src="${pageContext.request.contextPath}img/xueshujiaoliu.jpg" /></a>
                <p><a href="#">学术交流</a>
                <p>家里蹲大学的管理机构的设置情况</p>
                </p>
            </li>
